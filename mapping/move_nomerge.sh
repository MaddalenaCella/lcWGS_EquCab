...
# Desc: move files that do not require merging to merged folder

CODE_DIR=rds/general/project/human-popgen-datasets/live/Maddalena/EquSeq/
OUT_DIR=$CODE_DIR/results/wgs_data/merged/
...
do
	...
	mv $CODE_DIR/results/wgs_data/sorted/$file.bam $OUT_DIR
    mv $CODE_DIR/results/wgs_data/sorted/$file.bam.bai $OUT_DIR
done